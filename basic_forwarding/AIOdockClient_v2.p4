...
const bit<48> OUT_MAC_SRC1 =  0x0242bcd1c999;
const bit<48> OUT_MAC_DST1 =  0x0242ac120002;
const bit<48> OUT_MAC_SRC2 =  0x0242aaedc672;
const bit<48> OUT_MAC_DST2 =  0x0242ac130002;
const bit<48> OUT_MAC_SRC3 =  0x0242a0145bd2;
const bit<48> OUT_MAC_DST3 =  0x0242ac140002;

const bit<16> GTP_UDP_PORT     = 2152;
const bit<48> SRC_DECAP_MAC = 0xfa163eef3111;
const bit<48> DST_DECAP_MAC = 0xfa163e146fc1;
const bit<32> DIP = 0xc0a8124d;
const bit<48> IN_MAC_SRC =  0xfa163e8021b1;
const bit<48> IN_MAC_DST =  0xfa163ed02ed0;
const bit<32> SIP1 = 0x0a0a1401;
const bit<32> SIP2 = 0x0a0a1201;
